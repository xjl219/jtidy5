...
import org.w3c.tidy5.TidyMessage.Level;
...
public final class Report
{
    ...
    static
    {
        try
        {
            res = ResourceBundle.getBundle("org/w3c/tidy5/TidyMessages");
        }
    ...
    public final static PrintWriter NO_OUT = new PrintWriter(new Writer() {
		
		@Override
		public void write(char[] cbuf, int off, int len) throws IOException {
			LOG.debug(new String(cbuf));
		}
